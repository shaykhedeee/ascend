...
export default function DocsPage() {
      ...
      <div className="mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="mb-8 border border-zinc-900 bg-zinc-950">
          <div className="flex items-center gap-2 border-b border-zinc-900 px-5 py-2">
            ...
            <span className="font-mono text-[11px] tracking-widest text-orange-600">RESURGO :: DEVELOPER_DOCS</span>
          </div>
          <div className="p-6">
        ...
        <div id="quickstart" className="mb-6 border border-zinc-900 bg-zinc-950">
          ...
          <div className="p-5 space-y-4 font-mono text-sm">
            <div className="space-y-2">
              <p className="text-[11px] tracking-widest text-zinc-400">1. GENERATE_API_KEY</p>
              <p className="text-zinc-400">Go to Dashboard &rarr; Integrations &rarr; API Keys &rarr; Generate Key</p>
            </div>
            <div className="space-y-2">
              <p className="text-[11px] tracking-widest text-zinc-400">2. MAKE_FIRST_REQUEST</p>
  ...
  -H "x-api-key: rsg_your_key_here"`}</pre>
            ...
            <div className="space-y-2">
              <p className="text-[11px] tracking-widest text-zinc-400">3. RESPONSE</p>
              <div className="border border-zinc-800 bg-black p-4">
  ...
  "endpoints": {
    ...
    "stats": "/api/v1/stats"
            ...
            <div className="space-y-2">
              <p className="text-[11px] tracking-widest text-zinc-400">4. CREATE_A_GOAL</p>
              <div className="border border-zinc-800 bg-black p-4">
...
Authorization: Bearer rsg_your_api_key_here`}</pre>
            ...
            <div className="border border-dashed border-zinc-800 bg-black/50 p-3 text-xs">
              <p className="text-yellow-400 font-bold text-[11px] tracking-widest mb-1">SECURITY_NOTE</p>
          ...
          <div className="divide-y divide-zinc-900">
            {CORE_ENDPOINTS.map(({ method, path, desc }) => (
              <div key={path + method} className="flex items-center gap-4 px-5 py-3">
                <span className={`shrink-0 border px-2 py-0.5 font-mono text-[11px] font-bold tracking-widest ${methodColor(method)}`}>
                  {method}
                </span>
    ...
    "status": "active"
        ...
        <div className="mb-6 border border-zinc-900 bg-zinc-950">
          ...
          <div className="p-5 space-y-3">
            <p className="font-mono text-[11px] tracking-widest text-zinc-400">REQUEST_BODY</p>
            <div className="border border-zinc-800 bg-black p-4">
  ...
  "context": { "currentStreak": 5, "level": 12 }
            ...
            <p className="font-mono text-[11px] tracking-widest text-zinc-400">RESPONSE</p>
            <div className="border border-zinc-800 bg-black p-4">
              <pre className="text-xs text-orange-400 overflow-x-auto">{`{
    ...
    "Review progress tomorrow"
        ...
        <div id="webhooks" className="mb-6 border border-zinc-900 bg-zinc-950">
          ...
          <div className="p-5 space-y-4 font-mono text-sm text-zinc-400">
            ...
            <div className="space-y-2">
              <p className="text-[11px] tracking-widest text-zinc-300 font-bold">AVAILABLE_EVENTS</p>
            ...
            <div className="space-y-2">
              <p className="text-[11px] tracking-widest text-zinc-300 font-bold">WEBHOOK_PAYLOAD_EXAMPLE</p>
              <div className="border border-zinc-800 bg-black p-4">
                <pre className="text-xs text-orange-400 overflow-x-auto">{`{
  "event": "habit.logged",
  ...
  "signature": "sha256=..."
          ...
          <div className="grid divide-x divide-zinc-900 grid-cols-3">
            {[
              ...
              <div key={plan} className="p-5 text-center">
                <p className="font-mono text-[11px] tracking-widest text-zinc-400">{plan}</p>
                <p className="mt-2 font-mono text-lg font-bold text-zinc-200">{limit}</p>
                <p className="mt-1 font-mono text-[11px] text-zinc-400">{note}</p>
              </div>
            ))}
          </div>
        ...
        <div id="errors" className="mb-6 border border-zinc-900 bg-zinc-950">
          ...
          <div className="divide-y divide-zinc-900">
            {ERROR_CODES.map(({ code, meaning }) => (
              <div key={code} className="flex items-center gap-4 px-5 py-2.5">
                <span className={`shrink-0 border px-2 py-0.5 font-mono text-[11px] font-bold tracking-widest ${
          ...
          <div className="border-t border-zinc-900 p-4">
            <p className="font-mono text-[11px] tracking-widest text-zinc-400 mb-2">ERROR_RESPONSE_FORMAT</p>
