// ═══════════════════════════════════════════════════════════════════════════════
// RESURGO.life - Terms of Service Page
// ═══════════════════════════════════════════════════════════════════════════════
...
export const metadata = {
  title: 'Terms of Service | RESURGO.life',
  description: 'RESURGO.life Terms of Service — Rules and guidelines for using our platform.',
};
    ...
    <div className="min-h-screen bg-[#0A0A0B] text-white">
      ...
      <header className="border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
          <Link href="/" className="inline-flex items-center gap-3 group">
            ...
            <span className="font-bold text-lg">RESURGO.life</span>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              By accessing and using RESURGO.life (&quot;the App&quot;), you accept and agree to be bound by these 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO.life is an AI-powered life management platform that helps users organize their lives through brain dump parsing, habit tracking, goal achievement, and personalized AI coaching. 
          ...
          <section>
            ...
            <div className="text-white/70 leading-relaxed space-y-4">
              <p><strong className="text-white">Free Plan:</strong> Access to core features with limits on goals (3), brain dumps (5/day), and AI messages (10/day).</p>
              <p><strong className="text-white">Pro Monthly ($4.99/month):</strong> Unlimited access to all features. Cancel anytime.</p>
              <p><strong className="text-white">Pro Yearly ($29.99/year):</strong> Same as Pro Monthly at ~$2.50/mo effective.</p>
              <p><strong className="text-white">Lifetime ($49.99 one-time):</strong> Perpetual access to all current and future features.</p>
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO.life, including its logo, design, features, and content, is protected by copyright, 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO.life is provided &quot;as is&quot; without warranties of any kind. We do not guarantee that 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              To the maximum extent permitted by law, RESURGO.life shall not be liable for any indirect, 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              <br />
              <a href="mailto:legal@resurgo.life" className="text-ascend-400 hover:underline">
                legal@resurgo.life
              </a>
            </p>
          </section>
      ...
      <footer className="border-t border-white/5 py-8 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center text-white/40 text-sm">
          © 2026 RESURGO.life. All rights reserved.
        </div>
      </footer>
    </div>
  );
