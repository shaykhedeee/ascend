// ═══════════════════════════════════════════════════════════════════════════════
// RESURGO.life - Privacy Policy Page
// ═══════════════════════════════════════════════════════════════════════════════
...
export const metadata = {
  title: 'Privacy Policy | RESURGO.life',
  description: 'RESURGO.life Privacy Policy — How we protect your data and respect your privacy.',
};
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO.life is designed with your privacy as a core principle. We believe your personal data 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed mb-4">
              <strong className="text-white">Local-First Approach:</strong> RESURGO.life stores your data 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO.life uses essential cookies only for maintaining your session and preferences. 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO.life is not intended for children under 13 years of age. We do not knowingly 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              <br />
              <a href="mailto:privacy@resurgo.life" className="text-ascend-400 hover:underline">
                privacy@resurgo.life
              </a>
            </p>
          </section>
        </div>
