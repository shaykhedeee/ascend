...
export default function DocsPage() {
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 p-4">
            {[
              ...
              <a key={anchor} href={anchor}
                className="border border-zinc-800 px-3 py-2 font-mono text-[10px] text-zinc-400 hover:bg-zinc-900 hover:text-zinc-200 transition text-center">
                {label}
              </a>
            ))}
          </div>
  ...
  "endpoints": {
    ...
    "stats": "/api/v1/stats"
            ...
            <div className="space-y-2">
              <p className="text-[9px] tracking-widest text-zinc-400">4. CREATE_A_GOAL</p>
              <div className="border border-zinc-800 bg-black p-4">
...
Authorization: Bearer rsg_your_api_key_here`}</pre>
            ...
            <div className="border border-dashed border-zinc-800 bg-black/50 p-3 text-xs">
              <p className="text-yellow-400 font-bold text-[9px] tracking-widest mb-1">SECURITY_NOTE</p>
          ...
          <div className="divide-y divide-zinc-900">
            {CORE_ENDPOINTS.map(({ method, path, desc }) => (
              <div key={path + method} className="flex items-center gap-4 px-5 py-3">
                <span className={`shrink-0 border px-2 py-0.5 font-mono text-[9px] font-bold tracking-widest ${methodColor(method)}`}>
                  {method}
                </span>
    ...
    "status": "active"
        ...
        <div className="mb-6 border border-zinc-900 bg-zinc-950">
          ...
          <div className="p-5 space-y-3">
            <p className="font-mono text-[9px] tracking-widest text-zinc-400">REQUEST_BODY</p>
            <div className="border border-zinc-800 bg-black p-4">
  ...
  "context": { "currentStreak": 5, "level": 12 }
            ...
            <p className="font-mono text-[9px] tracking-widest text-zinc-400">RESPONSE</p>
            <div className="border border-zinc-800 bg-black p-4">
              <pre className="text-xs text-orange-400 overflow-x-auto">{`{
    ...
    "Review progress tomorrow"
        ...
        <div id="webhooks" className="mb-6 border border-zinc-900 bg-zinc-950">
          ...
          <div className="p-5 space-y-4 font-mono text-sm text-zinc-400">
            ...
            <div className="space-y-2">
              <p className="text-[9px] tracking-widest text-zinc-300 font-bold">AVAILABLE_EVENTS</p>
            ...
            <div className="space-y-2">
              <p className="text-[9px] tracking-widest text-zinc-300 font-bold">WEBHOOK_PAYLOAD_EXAMPLE</p>
              <div className="border border-zinc-800 bg-black p-4">
                <pre className="text-xs text-orange-400 overflow-x-auto">{`{
  "event": "habit.logged",
  ...
  "signature": "sha256=..."
        ...
        <div id="errors" className="mb-6 border border-zinc-900 bg-zinc-950">
          ...
          <div className="divide-y divide-zinc-900">
            {ERROR_CODES.map(({ code, meaning }) => (
              <div key={code} className="flex items-center gap-4 px-5 py-2.5">
                <span className={`shrink-0 border px-2 py-0.5 font-mono text-[9px] font-bold tracking-widest ${
          ...
          <div className="border-t border-zinc-900 p-4">
            <p className="font-mono text-[9px] tracking-widest text-zinc-400 mb-2">ERROR_RESPONSE_FORMAT</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <div key={lang} className="border border-zinc-800 p-3 space-y-1">
                  ...
                  <code className="text-[10px] text-orange-400">{code}</code>
                </div>
              ))}
            </div>
          </div>
