// ═══════════════════════════════════════════════════════════════════════════════
// AscendifyIFY - Data Export Utilities
...
export async function exportToPDF(
  ...
  // Title
  doc.setFontSize(24);
  doc.setTextColor(20, 184, 153); // Ascendify color
  doc.text('Ascendify', pageWidth / 2, 20, { align: 'center' });
  ...
  doc.text('Generated by Ascendify - Rise to your potential', pageWidth / 2, pageHeight - 10, { align: 'center' });
