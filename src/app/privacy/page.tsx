...
// RESURGOIFY - Privacy Policy Page
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
export const metadata = {
  ...
  description: 'RESURGO Privacy Policy - How we protect your data and respect your privacy.',
};
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO is designed with your privacy as a core principle. We believe your personal data 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed mb-4">
              <strong className="text-white">Local-First Approach:</strong> RESURGO stores your data 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO uses essential cookies only for maintaining your session and preferences. 
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              RESURGO is not intended for children under 13 years of age. We do not knowingly 
